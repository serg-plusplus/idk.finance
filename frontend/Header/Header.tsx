...
import {Button, Container, Row, Spacer, useTheme, changeTheme} from "@nextui-org/react";
...
const ModeSwitcher: FC = () => {
  ...
  return (
    <Button onClick={handleChange} className="button header--mode-switcher" auto flat>
      <Icon/>
    </Button>
  );
}
